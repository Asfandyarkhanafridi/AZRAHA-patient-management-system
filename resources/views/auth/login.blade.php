...
<div class="content-wrapper">
    ...
    <div class="content-body">
        <div class="auth-wrapper auth-cover">
            <div class="auth-inner row m-2 w-100">
                <!-- Brand logo-->
                <a class="brand-logo w-100" href="{{route('home')}}">
                    ...
                    <h2 class="brand-text text-primary ms-1 w-100">Patient Management System</h2>
                </a>
                <!-- /Brand logo-->
                <!-- Left Text-->
                ...
                <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                    <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                        <h2 class="card-title fw-bold mb-1">Welcome to PMS! 👋</h2>
