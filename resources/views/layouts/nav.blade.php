        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item" aria-haspopup="true">
                    <a class="d-flex align-items-center @if(request()->route()->action['as'] == 'home') active @endif" href="{{route('home')}}"><i class="fa fa-home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboard</span></a>
                </li>
                @endcan
                ...
                @can('patients_read')
                    <li class=" nav-item" aria-haspopup="true">
                        <a class="d-flex align-items-center @if(request()->route()->action['as'] == 'patients.index') active @endif" href="{{route('patients.index')}}"><i class="fa fa-wheelchair"></i><span class="menu-title text-truncate" data-i18n="Patients">Patients</span></a>
                    </li>
                @endcan
                ...
                {{-- Admin --}}
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="#"><i class="fa fa-gears"></i><span class="menu-title text-truncate" data-i18n="Page Layouts">Admin</span></a>
                    <ul class="menu-content">
                        <li class=" nav-item" aria-haspopup="true">
                            <a class="d-flex align-items-center @if( request()->route()->action['as'] == 'profile.show') active @endif" href="{{route('profile.show')}}"><i class="fa fa-eye"></i><span class="menu-title text-truncate" data-i18n="Home">Profile</span></a>
                        </li>
                        <li class=" nav-item" aria-haspopup="true">
