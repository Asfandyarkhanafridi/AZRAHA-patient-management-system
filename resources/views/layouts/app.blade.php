...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0">
        <span class="float-md-end d-none d-md-block"> Made By <a href="https://asfand.bssma.edu.pk/">Muhammad Asfandyar Khan</a></span>
    </p>
</footer>
<!-- END: Footer-->
...
<script>
    ...
    function removeFilterPatientDetail() {
        if (window.location.href.indexOf("?") > -1) {
            $('#patient_id').val('');
            $('#filterPatientDetail').submit('')
