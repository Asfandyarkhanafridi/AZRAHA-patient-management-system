...
class PrivilegeSeeder extends Seeder
{
    ...
    public function run()
    {
        $aryPrivileges = [
            ...
            ['moduleID' => 7, 'accessLevelID' => 1, 'privilegeCode' => 'PATIENTS','privilegeName' => 'Patients Create'],
            ['moduleID' => 7, 'accessLevelID' => 2, 'privilegeCode' => 'PATIENTS','privilegeName' => 'Patients Read'],
            ['moduleID' => 7, 'accessLevelID' => 3, 'privilegeCode' => 'PATIENTS','privilegeName' => 'Patients Update'],
            ['moduleID' => 7, 'accessLevelID' => 4, 'privilegeCode' => 'PATIENTS','privilegeName' => 'Patients Delete']
